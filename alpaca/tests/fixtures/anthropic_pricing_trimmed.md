...
<!-- Test fixture: trimmed from the official page https://platform.claude.com/docs/en/about-claude/pricing.md as saved on 2026-09-25. Kept: the model pricing table and its notes, fast mode pricing, batch processing. -->
